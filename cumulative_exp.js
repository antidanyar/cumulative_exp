...
var items = [
    ...
    [["filler-GOOD", 10], "DashedAcceptabilityJudgment", {s: "На улице дрянная погода. Моросит."},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какая на улице погода?",
                    as: ["дрянная", "так себе", "хорошая"]}],
    [["filler-BAD", 10], "DashedAcceptabilityJudgment", {s: "На улице дрянная погода. Оно моросит."},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какая на улице погода?",
                    as: ["дрянная", "так себе", "хорошая"]}],

    [["filler-GOOD", 11], "DashedAcceptabilityJudgment", {s: "Кого лектор наругал, а семинарист похвалил?"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто наругал?",
                    as: ["лектор", "семинарист", "декан"]}],
    [["filler-BAD", 11], "DashedAcceptabilityJudgment", {s: "Кого лектор наругал, а семинарист поставил 5?"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто наругал?",
                    as: ["лектор", "семинарист", "декан"]}],

    [["filler-GOOD", 12], "DashedAcceptabilityJudgment", {s: "Мне кажется, мы нашли что-то невероятное, на этом можно заработать миллионы!"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Сколько можно заработать на находке?",
                    as: ["миллионы", "горы золота", "десятки тысяч"]}],
    [["filler-BAD", 12], "DashedAcceptabilityJudgment", {s: "Мне кажется, мы нашли что-либо невероятное, на этом можно заработать миллионы!"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Сколько можно заработать на находке?",
                    as: ["миллионы", "горы золота", "десятки тысяч"]}],

    [["filler-GOOD", 13], "DashedAcceptabilityJudgment", {s: "Эти дураки всё сломали ещё вчера, машину уже не починить"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что сломалось?",
                    as: ["машина", "велосипед", "мотоцикл"]}],
    [["filler-BAD", 13], "DashedAcceptabilityJudgment", {s: "Эти дураки всё сломают ещё вчера, машину уже не починить"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что сломалось?",
                    as: ["машина", "велосипед", "мотоцикл"]}],

    [["filler-GOOD", 14], "DashedAcceptabilityJudgment", {s: "Тот факт, что Иван не пришёл, ни на что не влияет, мы все равно его побъём"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что сделают с Иваном?",
                    as: ["побьют", "утопят", "застрелят"]}],
    [["filler-BAD", 14], "DashedAcceptabilityJudgment", {s: "Тот факт, что Иван не пришёл, ни на что влияет, мы все равно его побъём"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что сделают с Иваном?",
                    as: ["побьют", "утопят", "застрелят"]}],

    [["filler-GOOD", 15], "DashedAcceptabilityJudgment", {s: "Что Коля съел, выпив лимонад?"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что Коля выпил?",
                    as: ["лимонад", "кофе", "сок"]}],
    [["filler-BAD", 15], "DashedAcceptabilityJudgment", {s: "Что Коля съел и выпил лимонад?"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что Коля выпил?",
                    as: ["лимонад", "кофе", "сок"]}], 

    [["filler-GOOD", 16], "DashedAcceptabilityJudgment", {s: "На улице стемнело, и ребята достали фейерверки"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что достали ребята?",
                    as: ["фейерверки", "лопаты", "фонарики"]}],
    [["filler-BAD", 16], "DashedAcceptabilityJudgment", {s: "Улица стемнела, и ребята достали фейерверки"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что достали ребята?",
                    as: ["фейерверки", "лопаты", "фонарики"]}],

    [["filler-GOOD", 17], "DashedAcceptabilityJudgment", {s: "Этот новый дом купила какая-то богатенькая дама"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто купил дом?",
                    as: ["богатая дама", "богатый бизнесмен", "семейная пара"]}],
    [["filler-BAD", 17], "DashedAcceptabilityJudgment", {s: "Этот новое дом купила какая-то богатенькая дама"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто купил дом?",
                    as: ["богатая дама", "богатый бизнесмен", "семейная пара"]}],

    [["filler-GOOD", 18], "DashedAcceptabilityJudgment", {s: "Завтра я поеду к бабушке, она мне испечет пирожков с капустой"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какие пирожки испечет бабушка?",
                    as: ["с капустой", "в мясом", "с брусникой"]}],
    [["filler-BAD", 18], "DashedAcceptabilityJudgment", {s: "Завтра я поехал к бабушке, она мне испечет пирожков с капустой"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какие пирожки испечет бабушка?",
                    as: ["с капустой", "в мясом", "с брусникой"]}],

    [["filler-GOOD", 19], "DashedAcceptabilityJudgment", {s: "Таня купила такие красивые сережки, причем не кому-то, а самой себе!"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какие сережки купила Таня?",
                    as: ["красивые", "золотые", "дорогие"]}],
    [["filler-BAD", 19], "DashedAcceptabilityJudgment", {s: "Таня купила такие красивые сережки, причем не кому-то, а самому себе!"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какие сережки купила Таня?",
                    as: ["красивые", "золотые", "дорогие"]}],

    [["filler-GOOD", 20], "DashedAcceptabilityJudgment", {s: "Никто не знает, где работает его мама."},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что никто не знает о его маме?",
                    as: ["где она работает", "сколько она задолжала", "какие пироги она любит"]}],
    [["filler-BAD", 20], "DashedAcceptabilityJudgment", {s: "Никто не знает, работает его мама где."},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что никто не знает о его маме?",
                    as: ["где она работает", "сколько она задолжала", "какие пироги она любит"]}],

    [["filler-GOOD", 21], "DashedAcceptabilityJudgment", {s: "Иван прочитал \"Евгения Онегина\" за пять дней"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что читал Иван?",
                    as: ["\"Евгения Онегина\"", "\"Мертвые души\"", "\"Преступление и наказание\""]}],
    [["filler-BAD", 21], "DashedAcceptabilityJudgment", {s: "Иван читал \"Евгения Онегина\" за пять дней"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Что читал Иван?",
                    as: ["\"Евгения Онегина\"", "\"Мертвые души\"", "\"Преступление и наказание\""]}],

    [["filler-GOOD", 22], "DashedAcceptabilityJudgment", {s: "Женя посоветовал ему самому с этим разобраться"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто дал ему совет?",
                    as: ["Женя", "Вася", "Коля"]}],
    [["filler-BAD", 22], "DashedAcceptabilityJudgment", {s: "Женя посоветовал ему сам с этим разобраться"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Кто дал ему совет?",
                    as: ["Женя", "Вася", "Коля"]}],

    [["filler-GOOD", 23], "DashedAcceptabilityJudgment", {s: "Лёша пробежал 100 метров за 10 секунд"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какую дистанцию бежал Лёша?",
                    as: ["100 метров", "50 метров", "20 метров"]}],
    [["filler-BAD", 23], "DashedAcceptabilityJudgment", {s: "Лёша бежал 100 метров за 10 секунд"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какую дистанцию бежал Лёша?",
                    as: ["100 метров", "50 метров", "20 метров"]}],

    [["filler-GOOD", 24], "DashedAcceptabilityJudgment", {s: "Следователь спросил у него, что он делал в ночь с 15 на 16"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какой ночью интересовался следователь?",
                    as: ["с 15 на 16", "с 16 на 17", "с 10 на 11"]}],
    [["filler-BAD", 24], "DashedAcceptabilityJudgment", {s: "Следователь спросил у него, он делал что в ночь с 15 на 16"},
                    "Question", {hasCorrect: true, randomOrder: true,
                    q: "Какой ночью интересовался следователь?",
                    as: ["с 15 на 16", "с 16 на 17", "с 10 на 11"]}]
